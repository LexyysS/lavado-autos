...
const ParallaxLavado = ({url,tapiz2,tapiz3,focos,patentes,simunizado,i4x4,iAuto,iSuv}) => {
  return (
    <ParallaxBanner
      ...
      className="h-1/2 "
    >
        <div className="lg:h-[120vh] md:h-[130vh] sm:h-[130vh] h-[190vh] w-full xl:px-60 lg:px-50 md:px-28 px-5 py-5 bg-cover bg-no-repeat bg-center flex flex-col" style={{backgroundColor:'rgba(0,0,0,0.75)', WebkitFilter:'blur(0px) saturate(1)'}}>
            <Typography variant="heading-3" className="uppercase font-bold pt-12 mb-8 text-[#98ceae] text-[min(8vw,3rem)] text-center sm:text-left">Limpieza de tapiz</Typography>
            ...
            <div className="w-full lg:h-1/2 h-4/5 md:h-2/3 pb-5 flex lg:flex-row md:flex-col flex-col gap-3 justify-center items-center mt-1">
